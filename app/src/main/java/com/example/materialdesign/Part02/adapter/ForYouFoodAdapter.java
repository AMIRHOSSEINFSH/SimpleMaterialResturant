...
public class ForYouFoodAdapter extends RecyclerView.Adapter<ForYouFoodAdapter.MyFoodViewHolder> {

    Context context;
    List<Food> foodList;

    public ForYouFoodAdapter(Context context, List<Food> foodList){
    ...
    public MyFoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyFoodViewHolder(LayoutInflater.from(context).inflate(R.layout.item_for_food,parent,false));
    }
